...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Jenifa J - Node.js Developer" },
      { name: "description", content: "Portfolio of Jenifa J, a Node.js Developer specializing in React, Express.js, Flutter, and AI-driven automation." },
      { name: "author", content: "Jenifa J" },
      { property: "og:title", content: "Jenifa J - Node.js Developer" },
      { property: "og:description", content: "React / Node.js / Express.js / Flutter / AI automation. Building scalable products end-to-end." },
...
const $$splitComponentImporter = () => import("./index-Dff2-b1C.js");
